...
This is the C# version. We also offer a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Web_WingScanDemo_VB_x64).
...
```
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Web_WingScanDemo_CS_x64.git WingScanDemo
```
